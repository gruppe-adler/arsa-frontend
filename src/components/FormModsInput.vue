...
function addMod() {
    ...
    localMods.value.push({
        modId: modIdInput?.value || '',
        name: nameInput?.value || '',
        version: versionInput?.value || '',
        required: requiredInput?.checked || true
    });
    modIdInput.value = '';
    nameInput.value = '';
    versionInput.value = '';
...
function mod2string(mod: Mod) {
    return `${mod.name} v${mod.version} (${mod.modId}) ${mod.required ? 'required' : 'not required'}`;
}
    ...
    <div class="form-input-container">
        ...
        <div>
            ...
            <div class="mod-modify-group">
                ...
                <input :id="requiredInputId" class="checkbox" type="checkbox" :disabled="props.readonly" />
                <br />
