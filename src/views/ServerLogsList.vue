...
<template>
  ...
  <ul id="logs">
    <li v-for="serverLog in sortedServerLogs">
      {{ serverLog }}:
      <RouterLink class="links" :to="`/view-server-log/${route.params.id}/${serverLog}/console.log`">console.log
      </RouterLink>
      <RouterLink class="links" :to="`/view-server-log/${route.params.id}/${serverLog}/error.log`">error.log
      </RouterLink>
      <RouterLink class="links" :to="`/view-server-log/${route.params.id}/${serverLog}/script.log`">script.log
      </RouterLink>
